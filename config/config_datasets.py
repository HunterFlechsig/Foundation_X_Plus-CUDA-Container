...
DATASETS_CONFIG = {
    ...
    "cls_candidptx_root": "/data/jliang12/shared/dataset/CANDID-PTX/",
    "cls_candidptx_trainList": "/data/jliang12/shared/dataset/CANDID-PTX/data_files_splits/candid_ptx/CANDIDPTX_cls_train.txt",
    "cls_candidptx_valList": "/data/jliang12/shared/dataset/CANDID-PTX/data_files_splits/candid_ptx/CANDIDPTX_cls_val.txt",
    "cls_candidptx_testList": "/data/jliang12/shared/dataset/CANDID-PTX/data_files_splits/candid_ptx/CANDIDPTX_cls_test.txt",

    "loc_candidptx_trainTag": "candidptx_pneumothorax_train_full",
    "loc_candidptx_testTag": "candidptx_pneumothorax_val",
    "loc_candidptx_root": "/data/jliang12/shared/dataset/CANDID-PTX/png",
    "loc_candidptx_trainList": "/data/jliang12/shared/dataset/CANDID-PTX/data_files_splits/candid_ptx/CANDID_PTX_train_1.json",
    "loc_candidptx_valList": "/data/jliang12/shared/dataset/CANDID-PTX/data_files_splits/candid_ptx/CANDID_PTX_valid_1.json",
    "loc_candidptx_testList": "/data/jliang12/shared/dataset/CANDID-PTX/data_files_splits/candid_ptx/CANDID_PTX_test_1.json",

    "seg_candidptx_root": "/data/jliang12/shared/dataset/CANDID-PTX/dataset",
    "seg_candidptx_trainList": "/data/jliang12/shared/dataset/CANDID-PTX/data_files_splits/candid_ptx/train.txt",
    "seg_candidptx_testList": "/data/jliang12/shared/dataset/CANDID-PTX/data_files_splits/candid_ptx/test.txt",
