...
DATASETS_CONFIG = {
    ...
    # Scratch copy. Localization JSON stays in bbox_annotation_pneumothorax/.
    # Classification and segmentation lists are generated under data_files_splits/.
    "cls_candidptx_root": "/scratch/hflechsi/CANDID-PTX/dataset/",
    ...
    "loc_candidptx_testTag": "candidptx_pneumothorax_test",
    "loc_candidptx_root": "/scratch/hflechsi/CANDID-PTX/png",
    "loc_candidptx_trainList": "/scratch/hflechsi/CANDID-PTX/bbox_annotation_pneumothorax/CANDID_PTX_train_1.json",
    "loc_candidptx_valList": "/scratch/hflechsi/CANDID-PTX/bbox_annotation_pneumothorax/CANDID_PTX_valid_1.json",
    "loc_candidptx_testList": "/scratch/hflechsi/CANDID-PTX/bbox_annotation_pneumothorax/CANDID_PTX_test_1.json",
